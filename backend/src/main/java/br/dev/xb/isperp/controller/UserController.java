...
public class UserController {
    ...
    @PostMapping
    public ResponseEntity<?> createUser(@Valid @NonNull @RequestBody User user) {
        try {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> updateUser(@PathVariable @NonNull UUID id, @Valid @NonNull @RequestBody User userDetails) {
        try {
